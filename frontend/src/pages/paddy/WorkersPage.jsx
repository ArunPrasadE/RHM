...
const WORKER_CATEGORIES = [
  { value: 'supervisor', label: 'Supervisor', labelTamil: 'மேற்பார்வையாளர்' },
  { value: 'harvester', label: 'Harvester', labelTamil: 'அறுவடையாளர்' },
  { value: 'tractor_man', label: 'Tractor Man', labelTamil: 'டிராக்டர் ஓட்டி' },
  { value: 'plough_man', label: 'Plough Man', labelTamil: 'உழவர்' },
];

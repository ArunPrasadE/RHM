      ...
      <div className="max-w-5xl w-full">
        ...
        <div className="mb-6">
          <button
            ...
            className="w-full p-6 bg-gradient-to-r from-primary-500 to-blue-600 hover:from-primary-600 hover:to-blue-700 rounded-xl shadow-lg transition-all duration-200 text-left"
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/80 mt-1">View unified dashboard across all modules</p>
              </div>
